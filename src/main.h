...
static const int64 MAX_MONEY = 350000000 * COIN; // Zeuscoin: maximum of 350M coins
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > COIN * 2880 / 250; // Zeuscoin: 2880 blocks found a day. Priority cutoff is 1 zeuscoin day / 250 bytes.
    }
...
public:
    ...
    {
        CKey key;
        if (!key.SetPubKey(ParseHex("0441234678901234567890077771222333444555666777888999000000aaaaabbbbbcccccdddddeeeeeff00ff00ff00ff001234567890abcdef0022446688abc89")))
